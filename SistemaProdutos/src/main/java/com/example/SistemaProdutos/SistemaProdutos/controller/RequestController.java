...
public class RequestController {
    ...
    public ArrayList<Product> printById(@RequestParam(value="id",defaultValue = "bxa8lza!?")String id) {
    ...
    public ArrayList<Product> updateProduct(@RequestParam(value="id",defaultValue = "bxa8lza!?")String id, @RequestBody Product newProduct) {
